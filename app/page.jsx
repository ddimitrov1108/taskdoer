...
export default function Home() {
  ...
  return (
    <div className="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg.svg');">
	...
	<div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
		...
		<div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
			...
			<p className="text-blue-400 font-bold pb-8 lg:pb-6 text-center md:text-left fade-in">Continue to our app!</p>
			<div className="flex w-full justify-center md:justify-start pb-24 lg:pb-0 fade-in">
				<Image src="App Store.svg" className="h-12 pr-4 bounce-top-icons"/>
				<Image src="Play Store.svg" className="h-12 bounce-top-icons"/>
			</div>

		</div>
		
		<div className="w-full xl:w-3/5 py-6 overflow-y-hidden">
			<Image className="w-5/6 mx-auto lg:mr-0 slide-in-bottom" src="devices.svg"/>
		</div>
		
		<div className="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
			<a className="text-gray-500 no-underline hover:no-underline" href="#">&copy; TaskDoer 2023</a>
		</div>
	</div>
</div>
  )
