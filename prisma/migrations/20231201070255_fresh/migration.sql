...
CREATE TABLE `users` (
    ...
    `theme` VARCHAR(9) NOT NULL DEFAULT '#4073FF',
...
-- AddForeignKey
ALTER TABLE `tasks` ADD CONSTRAINT `tasks_pid_fkey` FOREIGN KEY (`pid`) REFERENCES `projects`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
